...
<div style="max-width:600px;margin:0 auto;background:#fff">
  ...
  <div style="padding:32px">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border:1px solid #eee;margin-bottom:24px">
      ...
      <tfoot>
        <tr>
          <td colspan="2" style="padding:8px 16px;font-size:12px;color:#888">Discount <span style="background:#B8892A;color:#fff;font-size:10px;padding:1px 6px;border-radius:2px;font-weight:700;letter-spacing:.06em">DYLAN10</span></td>
          <td style="padding:8px 16px;font-size:13px;color:#B8892A;text-align:right;font-weight:700">-$${(total * 0.10).toFixed(2)}</td>
        </tr>
        <tr>
          ...
          <td style="padding:10px 16px;font-size:16px;font-weight:900;color:#B8892A;text-align:right;border-top:1px solid #eee">$${(total * 0.90).toFixed(2)}</td>
        </tr>
      </tfoot>
    </table>
